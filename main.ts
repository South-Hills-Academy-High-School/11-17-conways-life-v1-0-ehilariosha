...
function updateGrid () {
    ...
    for (let row = 0; row <= 11; row++) {
        ...
        for (let column = 0; column <= 15; column++) {
            ...
            currentCellNeighbor = countNeighbors(row, column)
            if (currentCellAliveOrDead == 1 && currentCellNeighbor < 2) {
                nextGrid[row].push(0)
            } else if (currentCellAliveOrDead == 1 && currentCellNeighbor > 3) {
                nextGrid[row].push(0)
            } else if (currentCellAliveOrDead == 0 && currentCellNeighbor == 3) {
                nextGrid[row].push(1)
            } else {
